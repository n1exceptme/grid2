...
Ext.onReady(function(){
    ...
    var grid4 = Ext.define('Ext.ux.LiveSearchGridPanel', {
		extend: 'Ext.grid.Panel',
		id:'button-grid',
        store: getLocalStore(),
        columns: [
            Ext.create('Ext.grid.RowNumberer'),
			{text: "Company", width: 200, flex: 1, sortable: true, dataIndex: 'company'},
            {text: "Price", width: 120, sortable: true, renderer: Ext.util.Format.usMoney, dataIndex: 'price'},
            {text: "Change", width: 120, sortable: true, dataIndex: 'change'},
            {text: "% Change", width: 120, sortable: true, dataIndex: 'pctChange'},
            {text: "Last Updated", width: 135, sortable: true, renderer: Ext.util.Format.dateRenderer('m/d/Y'), dataIndex: 'lastChange'}
        ],
        columnLines: true,
        selModel: selModel,
		frame: true,
		...
		},
		{
            ...
            items: [{
                ...
                itemId: 'ConsumiPOD',
                text:'Visualizza Consumi',
                tooltip:'Visualizza i consumi relativi ai POD selezionati'
            }]
        }],
